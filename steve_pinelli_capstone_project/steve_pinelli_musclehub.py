...
# First trim the data to start date 7-1-17
df = sql_query('''
...
from matplotlib import pyplot as plt
plt.pie(ab_counts['first_name'], labels=['Group A', 'Group B'], autopct='%0.2f%%')
plt.axis('equal')
plt.title('Percentage of Visitors by Group')
...
plt.savefig("visitor_applications.png")
plt.show()
...
plt.savefig("applicant_memberships.png")
plt.show()
...
plt.savefig("visitor_memberships.png")
plt.show()
